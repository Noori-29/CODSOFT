...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "BSSE","CS","BBA"};
	private String[] yearString = new String[] {"1st","2nd","3rd","4th"};
	private String[] subjectSEString = new String[] {"ITC","DB", "PF", "DSA"};
	private String[] subjectTEString = new String[] {"ITC","DB", "PF", "DSA"};
	private String[] subjectBEString = new String[] {"ITC","DB", "PF", "DSA"};

	private String[] subjectFinal = new String[] {"ITC","DB", "PF", "DSA"};
